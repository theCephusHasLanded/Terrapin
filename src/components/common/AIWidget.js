...
const aiResponses = {
  ...
  'ordering': 'To place an order, simply browse our collections, select the items you want, add them to your cart, and proceed to checkout. You can pay using major credit cards, PayPal, or Apple Pay. Once your order is confirmed, you'll receive an email with your order details.',
